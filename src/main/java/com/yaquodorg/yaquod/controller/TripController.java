...
public class TripController {
    ...
    public ResponseEntity<ApiResponse<Request>> createRequest(@RequestBody TripRequestDto tripRequestDto,
        ...
        try {
            Request request = requestService.createRequest(user.getId(), tripRequestDto.getStartLong(),
                    tripRequestDto.getStartLat(), tripRequestDto.getEndLong(), tripRequestDto.getEndLat());
    ...
    public ResponseEntity<ApiResponse<MessageResponse>> deleteTripById(
        ...
        try {
            ...
            return ResponseEntity.ok(createSuccessResponse(new MessageResponse("Trip deleted successfully")));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
    ...
    public ResponseEntity<ApiResponse<MessageResponse>> declineRequest(
        ...
        try {
            ...
            return ResponseEntity.ok(createSuccessResponse(new MessageResponse("Request declined successfully")));
        } catch (Exception e) {
            return ResponseEntity.badRequest()
