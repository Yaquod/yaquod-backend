...
public class VehicleController {
  ...
  public ResponseEntity<ApiResponse<CreateVehicleResponse>> createVehicle(
      @Valid @RequestBody CreateVehicleDto createVehicleDto, @AuthenticationPrincipal User user) {
    try {
  ...
  @Operation(
      ...
      description =
          "Retrieves a specific vehicle by its Vehicle Identification Number (VIN). Requires ADMIN role.")
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description = "Updates an existing vehicle with the provided data. Requires ADMIN role.")
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description = "Deletes a vehicle from the system by its database ID. Requires ADMIN role.")
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Sends an MQTT signal to request a location update from the vehicle. Requires ADMIN role.")
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Sends an MQTT signal to request a status update from the vehicle. Requires ADMIN role.")
  @ApiResponses(
      value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(
            responseCode = "200",
