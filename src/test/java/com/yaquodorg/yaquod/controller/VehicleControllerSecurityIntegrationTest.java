...
class VehicleControllerSecurityIntegrationTest {
  ...
  void shouldRequireAdminRoleForGetByVIN() throws Exception {
    mockMvc
        .perform(get("/api/vehicles/vin/test-vin"))
        .andDo(print())
        .andExpect(status().isForbidden());
  }
  ...
  void shouldRequireAdminRoleForLocationUpdate() throws Exception {
    mockMvc
        .perform(patch("/api/vehicles/vin/test-vin/location-update"))
        .andDo(print())
        .andExpect(status().isForbidden());
  }
  ...
  void shouldRequireAdminRoleForStatusUpdate() throws Exception {
    mockMvc
        .perform(patch("/api/vehicles/vin/test-vin/status-update"))
        .andDo(print())
        .andExpect(status().isForbidden());
  }
  ...
  void shouldPerformFullCrudFlow() throws Exception {
    ...
    // 2. Get vehicle by ID
    mockMvc
        .perform(get("/api/vehicles/id/{vehicleId}", vehicleId))
        .andDo(print())
        .andExpect(status().isOk())
    ...
    // 5. Delete vehicle
    mockMvc
        .perform(delete("/api/vehicles/id/{vehicleId}", vehicleId))
        .andDo(print())
        .andExpect(status().isOk())
  ...
  void shouldGetVehicleByVINAfterCreation() throws Exception {
    ...
    // Get by VIN
    mockMvc
        .perform(get("/api/vehicles/vin/{vinNumber}", vin))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true))
  ...
  void shouldReturn400ForNonExistentVehicleById() throws Exception {
    mockMvc
        .perform(get("/api/vehicles/id/999"))
        .andDo(print())
  ...
  void shouldReturn400ForNonExistentVehicleByVIN() throws Exception {
    mockMvc
        .perform(get("/api/vehicles/vin/non-existent-vin"))
        .andDo(print())
        .andExpect(status().isBadRequest())
        .andExpect(jsonPath("$.success").value(false));
  }
  ...
  void shouldSendLocationUpdateViaMQTT() throws Exception {
    ...
    mockMvc
        .perform(patch("/api/vehicles/vin/{vinNumber}/location-update", vin))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true))
  ...
  void shouldSendStatusUpdateViaMQTT() throws Exception {
    ...
    mockMvc
        .perform(patch("/api/vehicles/vin/{vinNumber}/status-update", vin))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true))
        .andExpect(jsonPath("$.data.message").value("Order signal sent!"));
  ...
  void shouldHandleMalformedJson() throws Exception {
    mockMvc
        .perform(
            post("/api/vehicles").contentType(MediaType.APPLICATION_JSON).content("{invalid json"))
        .andDo(print())
        .andExpect(status().isBadRequest());
  }
  ...
  void shouldHandleMissingContentType() throws Exception {
    mockMvc
        .perform(post("/api/vehicles").content(objectMapper.writeValueAsString(createVehicleDto)))
        .andDo(print())
