...
class VehicleControllerTest {
  ...
  void shouldGetVehicleById() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(get("/api/vehicles/id/{vehicleId}", 1L))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true))
  ...
  void shouldReturn400WhenVehicleNotFoundById() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(get("/api/vehicles/id/{vehicleId}", 999L))
        .andDo(print())
        .andExpect(status().isBadRequest())
        .andExpect(jsonPath("$.success").value(false))
  ...
  void shouldDeleteVehicle() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(delete("/api/vehicles/id/{vehicleId}", 1L))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true))
  ...
  void shouldReturn400WhenDeleteFails() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(delete("/api/vehicles/id/{vehicleId}", 999L))
        .andDo(print())
        .andExpect(status().isBadRequest())
        .andExpect(jsonPath("$.success").value(false))
  ...
  @Test
  @DisplayName(
      "PATCH /api/vehicles/vin/{vinNumber}/location-update - Should return 400 when MQTT fails")
  ...
  @Test
  @DisplayName(
      "PATCH /api/vehicles/vin/{vinNumber}/location-update - Should handle valid VIN for location update")
  ...
  void shouldHandleVeryLongVIN() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(get("/api/vehicles/vin/{vinNumber}", validVin))
        .andDo(print())
        .andExpect(status().isOk());
  ...
  void shouldHandleZeroVehicleId() throws Exception {
    ...
    // Act & Assert
    mockMvc
        .perform(get("/api/vehicles/id/{vehicleId}", 0L))
        .andDo(print())
        .andExpect(status().isBadRequest());
